...
class app(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.ar_navbar_frame.grid(row=0,
                                  column=0,
                                  columnspan=2,
                                  padx=20,
                                  pady=(10, 0),
        ...
        # label
        self.ar_label = ctk.CTkLabel(self.ar_navbar_frame,
                                     text="Action Requests:")
        self.ar_label.grid(row=0, column=0, padx=5, pady=5, sticky="nw")

        # Tab for Completed AR(s)
        self.completed_button = ctk.CTkButton(master=self.ar_navbar_frame,
                                              command=self.button_callback,
                                              text="Completed")
        self.completed_button.grid(row=0,
                                   column=1,
                                   padx=5,
                                   pady=5,
                                   sticky="nw")
        ...
        # Add button
        self.add_button = ctk.CTkButton(master=self.ar_navbar_frame,
                                        command=self.button_callback,
                                        text="Add")
        ...
        # Frame for ARs
        self.ar_frame = ctk.CTkFrame(master=self,
                                     width=200,
                                     height=300,
                                     corner_radius=5)
        self.ar_frame.grid(row=1,
                           column=0,
                           columnspan=2,
                           padx=20,
                           pady=(10, 10),
        ...
        self.notes_navbar_frame.grid(row=2,
                                     column=0,
                                     columnspan=2,
                                     padx=20,
                                     pady=(10, 0),
